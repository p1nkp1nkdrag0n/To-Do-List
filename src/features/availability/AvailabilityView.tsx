...
export function AvailabilityView({ projectId, currentUserId, online, invalidationVersion }: AvailabilityViewProps) {
  ...
  return (
    <div className="availability-view" data-tour-id="availability-content">
      <header className="availability-heading" data-tour-id="availability-semester">
